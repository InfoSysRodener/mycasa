...
<div>
    ...
    {{--</tr>--}}
    {{--@if($joborder->Services !== null){--}}
    {{--@foreach ($joborder->Services as  $accessory) {--}}
    {{--<tr>--}}
    {{--<td style="text-align: left !important; width: 80%">{{ $accessory['accessory_name'] == null ? "" : $accessory['accessory_name'] }}  </td>--}}
    {{--<td style=" text-align:center;width: 20%;text-decoration: underline">{{ $accessory['accessory_name'] == null ? "" : $accessory['accessory_qty'] }}  </td>--}}
    {{--<td style=" text-align:center;width: 20%;text-decoration: underline">{{ $accessory['accessory_name'] == null ? "" : number_format($accessory['accessory_cost']) }}  </td>--}}
    {{--</tr>--}}
    {{--}--}}
    {{--@endforeach--}}
    {{--}--}}
    ...
    {{--</tr>--}}
    {{--@if($joborder->Services !== null){--}}
    {{--@foreach ($joborder->Services as $misc) {--}}
    {{--<tr>--}}
    {{--<td style="text-align: left !important; width: 80%">{{ $misc['misc_name'] == null ? "" : $misc['misc_name'] }} </td>--}}
    {{--<td style=" text-align:center;width: 20%;">{{ $misc['misc_name'] == null ? "" : $misc['misc_qty'] }}  </td>--}}
    {{--<td style=" text-align:center;width: 20%;">{{ $misc['misc_name'] == null ? "" : number_format($misc['misc_cost']) }} </td>--}}
    {{--</tr>--}}
    {{--}--}}
    {{--@endforeach--}}
    {{--}--}}
    ...
    <table style="width:100%">
        ...
        {{--<td style=" text-align:center;width: 50%">Promotion discount</td>--}}
        {{--<td style=" text-align:center;width: 20%">( {{ number_format($joborder->discount) }} )</td>--}}
        {{--</tr>--}}
        <tr>
            <td style="text-align: left !important; width: 50%"></td>
